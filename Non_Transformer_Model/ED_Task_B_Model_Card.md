...
tags:
- text-classification
repo: https://github.com/Adam-Calleja/NLU_Project

---

# Model Card for ESIM + DistilBERT Non-Transformer Model
...
The hyperparameters were determined by experimentation with different values and the model selection was done by choosing the highest weighted F1 metric from all the models.
